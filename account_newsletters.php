...
<div class="contentContainer">
  <div class="contentText">
    <div class="form-group">
      <label for="newsletter" class="control-label col-xs-3"><?php echo MY_NEWSLETTERS_GENERAL_NEWSLETTER; ?></label>
      <div class="col-xs-9">
        <?php echo tep_bs_checkbox_field('newsletter_general',                   
		                                  '1', 
										  '', 
										  'inputNewsletter', 
										  (($newsletter['customers_newsletter'] == '1') ? true : false), 
										  'checkbox checkbox-success', 
										  '', 
										  '', 
										  'right' )	; 
        if (tep_not_null(MY_NEWSLETTERS_GENERAL_NEWSLETTER_DESCRIPTION)) echo '<br />' . MY_NEWSLETTERS_GENERAL_NEWSLETTER_DESCRIPTION;
        ?>
      </div> 
    </div>
  </div>	  
