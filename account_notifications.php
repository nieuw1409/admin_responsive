...
-->  
  <div class="contentText">
    <div class="form-group">
      <label for="newsletter" class="control-label col-xs-3"><?php echo GLOBAL_NOTIFICATIONS_TITLE; ?></label>
      <div class="col-xs-9">
        <?php echo tep_bs_checkbox_field('product_global',                   
		                                  '1', 
										  '', 
										  'inputGlobalNotification', 
										  (($global['global_product_notifications'] == '1') ? true : false), 
										  'checkbox checkbox-success', 
										  '', 
										  '', 
										  'right' )	; 
        if (tep_not_null(GLOBAL_NOTIFICATIONS_DESCRIPTION)) echo '<br />' . GLOBAL_NOTIFICATIONS_DESCRIPTION;
        ?>
      </div> 
	</div>
  </div>
...
?>
    ...
    <div class="contentText">
      <div class="form-group">
        <label class="control-label col-xs-3"><?php echo MY_NOTIFICATIONS_TITLE; ?></label>
        <div class="col-sm-9">
...
<?php
      ...
      while ($products = tep_db_fetch_array($products_query)) {
              echo tep_bs_checkbox_field('products[]',                   
                                          $products['products_id'], 
					                      $products['products_name'], 
										  'inputProductNotification', 
										  true, 
										  'checkbox checkbox-success', 
										  '', 
										  '', 
