...
<div class="contentContainer">
  ...
  <div class="contentText">
    ...
    <div class="buttonSet">
      <span class="buttonAction"><?php echo tep_draw_button(IMAGE_BUTTON_SEARCH, 'search', null, 'primary'); ?></span>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="' . <?php echo glyphicon_icon_to_fontawesome( "asterisk" ) ; ?> . '"></span></button> <!-- glyphicon glyphicon-remove -->
...
//        echo tep_draw_input_field('dfrom', '', 'id="dfrom" placeholder="' . ENTRY_DATE_FROM . '"');
        echo tep_draw_input_date('dfrom',                                             // name
	                              '',                                                 // value
									 'id="dfrom"',      // parameters
									 null,                                            // type
									 'true',                                          // reinsert value
									 ENTRY_DATE_FROM                                  // placeholder
									 ); 		
        ?>
      </div>
    </div>
...
//        echo tep_draw_input_field('dto', '', 'id="dto" placeholder="' . ENTRY_DATE_TO . '"');
        echo tep_draw_input_date('dto',                                               // name
	                              '',                                                 // value
									 'id="dto"',        // parameters
									 null,                                            // type
									 'true',                                          // reinsert value
									 ENTRY_DATE_TO                                    // placeholder
									 ); 				
        ?>
      </div>
    </div>
