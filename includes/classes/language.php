...
*/
  ...
  class language {
    var $languages, $catalog_languages, $browser_languages, $language, $aantal;
    ...
    function language($lng = '') {
      ...
      $languages_query = tep_db_query("select languages_id, name, code, image, directory, languages_to_stores from " . TABLE_LANGUAGES . " where  find_in_set('" . SYS_STORES_ID . "', languages_to_stores) != 0 order by sort_order");
      $this->aantal = 0 ;	  
