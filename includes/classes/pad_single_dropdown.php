    ...
    function _draw_stocked_attributes() {
      ...
      if (sizeof($attributes)>0) {
        ...
        $combname=substr($combname,2).':';
            ...
            $out.="<tr>\n";
            $out.='  			<td class="label label-info col-md-2">'.$combname. ' : </td><td class="col-md-10">'  ;
//            $out.='  <td align="right" class=main><strong>'.$combname."</strong></td>\n  <td class=main>"; 
            $out.=   tep_bootstrap_pull_down_menu( 'attrcomb', $combinations,$combinations[$selected_combination]['id'], $combinations[$selected_combination]['id'] ); //tep_draw_pull_down_menu('attrcomb', $combinations, $combinations[$selected_combination]['id']);
            $out.="</td>\n";
            $out.="</tr>\n";		
