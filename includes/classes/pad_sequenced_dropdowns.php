    ...
    function _draw_stocked_attributes() {
      ...
      for ($a=0; $a<$s; $a++) {
        ...
        if ($out_of_stock) {
          ...
          $out.='<tr><td class="label label-info col-md-2">'.$attributes[0]['oname']. ' : </td><td align="right" class=main><strong>'.tep_bootstrap_pull_down_menu('id['.$attributes[0]['oid'].']',array_merge(array(array('id'=>0, 'text'=>'First select '.$attributes[0]['oname'])), $attributes[0]['ovals']),$attributes[0]['oid'], $attributes[0]['default'], "onchange=\"i".$attributes[0]['oid']."(this.form);\"")."</td></tr>\n";

          // Draw second to next to last option dropdowns - no values, with onchange
          for($o=1; $o<sizeof($attributes)-1; $o++) {
            $out.='<tr><td class="label label-info col-md-2">'.$attributes[$o]['oname'].' : </td><td align="right" class=main><strong>'.tep_bootstrap_pull_down_menu('id['.$attributes[$o]['oid'].']',array(array('id'=>0, 'text'=>'Next select '.$attributes[$o]['oname'])),$attributes[$o]['oid'], '', "onchange=\"i".$attributes[$o]['oid']."(this.form);\"")."</td></tr>\n";
          }        

          // Draw last option dropdown - no values, no onchange      
          $out.='<tr><td class="label label-info col-md-2">'.$attributes[$o]['oname'].' : </td><td align="right" class=main><strong>'.tep_bootstrap_pull_down_menu('id['.$attributes[$o]['oid'].']',array(array('id'=>0, 'text'=>'Next select '.$attributes[$o]['oname'])),$attributes[$o]['oid'], '')."</td></tr>\n";
