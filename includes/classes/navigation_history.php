...
// 2.3.4        if ( ($this->path[$i]['page'] == basename($PHP_SELF)) ) {
      ...
      if ($set == 'true') {
// 2.3.4        $this->path[] = array('page' => basename($PHP_SELF),
...
// 2.3.4      if ($this->path[$last_entry_position]['page'] == basename($PHP_SELF)) {
...
// 2.3.4        $this->snapshot = array('page' => basename($PHP_SELF),
