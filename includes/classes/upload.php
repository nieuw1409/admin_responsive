...
// - Zappo - Option Types v2 - changed:  all references to $message_stack were commented out, since it is not defined here
...
// - Zappo - Option Types v2 - Added: $key to differentiate between different files uploaded
    function parse($key = '') {
      global $messageStack;
