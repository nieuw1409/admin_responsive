...
function trail($separator = NULL) {
	  $icon_home = ' class="' . glyphicon_icon_to_fontawesome( "home" ) . '"' ;
      $pos = 1;
      $trail_string = '<ol  itemscope itemtype="http://schema.org/BreadcrumbList" class="breadcrumb breadcrumb-arrow">';
      
	  $trail_string .= '<li><a href="#" class="btn btn-default"><i class="' . glyphicon_icon_to_fontawesome( "home" ) . '"></i></a></li>';	  
