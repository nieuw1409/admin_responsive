...
?>	  
  ...
  <div class="col-xs-9">  
    <div class="form-group">
        <?php echo tep_bs_radio_field('gender', 'm', MALE,     'input_Cust_gender_male',   $male,   'radio radio-success radio-inline', '', '', 'right') ; ?>
        <?php echo tep_bs_radio_field('gender', 'f', FEMALE,   'input_Cust_gender_female', $female, 'radio radio-success radio-inline', '', '', 'right') ; ?>
    </div>		
  </div>
<?php
  }
...
?>
      ...
      <div class="form-group has-feedback">
        ...
        <div class="col-xs-9">
          <?php
          echo tep_get_country_list('country', (isset($entry['entry_country_id']) ? $entry['entry_country_id'] : STORE_COUNTRY ), 'required aria-required="true"', 'inputCountry');
