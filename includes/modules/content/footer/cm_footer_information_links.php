...
*/
  ...
  class cm_footer_information_links {
    ...
    function enable() {
	  global $multi_stores_config;			
            tep_db_query("update " . $multi_stores_config  . " set configuration_value = 'True' where configuration_key = 'MODULE_CONTENT_FOOTER_INFORMATION_STATUS'");
            $this->enabled = (MODULE_CONTENT_FOOTER_INFORMATION_STATUS == 'True');
    ...
    function disable() {
	  global $multi_stores_config;			
            tep_db_query("update " . $multi_stores_config  . " set configuration_value = 'False' where configuration_key = 'MODULE_CONTENT_FOOTER_INFORMATION_STATUS'");
            $this->enabled = (MODULE_CONTENT_FOOTER_INFORMATION_STATUS == 'False');
