...
// Register PayPal Express Checkout as the default payment method
    ...
    function install($parameter = null) {
      ...
      foreach ($params as $key => $data) {
        ...
        tep_db_perform($multi_stores_config , $sql_data_array);
      }
    }
...
EOD;
   ...
   function enable() {
	  global $multi_stores_config;			
            tep_db_query("update " . $multi_stores_config  . " set configuration_value = 'True' where configuration_key = 'MODULE_CONTENT_PAYPAL_LOGIN_STATUS'");
            $this->enabled = (MODULE_CONTENT_PAYPAL_LOGIN_STATUS == 'True');
    ...
    function disable() {
	  global $multi_stores_config;			
            tep_db_query("update " . $multi_stores_config  . " set configuration_value = 'False' where configuration_key = 'MODULE_CONTENT_PAYPAL_LOGIN_STATUS'");
            $this->enabled = (MODULE_CONTENT_PAYPAL_LOGIN_STATUS == 'False');
