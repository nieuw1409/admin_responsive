<div class="contentContainer <?php echo (MODULE_CONTENT_LOGIN_FORM_CONTENT_WIDTH == 'Half') ? 'grid_12' : 'grid_24'; ?>">
 ...
 <!--   <p><?php echo '<a href="' . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . '">' . MODULE_CONTENT_LOGIN_TEXT_PASSWORD_FORGOTTEN . '</a>'; ?></p> -->
	...
	<p align="left"><?php echo tep_draw_button(MODULE_CONTENT_LOGIN_TEXT_PASSWORD_FORGOTTEN, 'info', tep_href_link(FILENAME_PASSWORD_FORGOTTEN ) , 'primary'); ?>
    <align="right"><?php echo tep_draw_button(IMAGE_BUTTON_LOGIN, 'key', null, 'primary'); ?></p>
