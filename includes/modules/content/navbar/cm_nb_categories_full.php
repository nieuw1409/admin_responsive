...
*/
  ...
  class cm_nb_categories_full {
   ...
   function enable() {
	  global $multi_stores_config;			
            tep_db_query("update " . $multi_stores_config  . " set configuration_value = 'True' where configuration_key = 'MODULE_CONTENT_NAVBAR_CATEGORIES_FULL_STATUS'");
            $this->enabled = (MODULE_CONTENT_NAVBAR_CATEGORIES_FULL_STATUS == 'True');
    ...
    function disable() {
	  global $multi_stores_config;			
            tep_db_query("update " . $multi_stores_config  . " set configuration_value = 'False' where configuration_key = 'MODULE_CONTENT_NAVBAR_CATEGORIES_FULL_STATUS'");
            $this->enabled = (MODULE_CONTENT_NAVBAR_CATEGORIES_FULL_STATUS == 'False');
