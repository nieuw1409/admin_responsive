...
$keyword_query = tep_db_query("select 1 FROM " . TABLE_HEADERTAGS_KEYWORDS . " where keyword = '" . tep_db_input($keyword) . "' and language_id = " . (int)$languages_id . " and find_in_set('" . SYS_STORES_ID . "', stores_id) != 0 "); // multi stores
