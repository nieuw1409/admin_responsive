<?php
  ...
  * @Id $Id:: usu5.php 196 2010-12-21 22:45:02Z Rob                     $:  Full Details   
  */
 
 /**
 * Load the general reusable functions
 */
  require DIR_WS_MODULES . 'ultimate_seo_urls5/includes/usu_general_functions.php';
  /**
  * @see Usu5_Bootstrap
  */
  require DIR_WS_MODULES . 'ultimate_seo_urls5/main/bootstrap.php';
  /**
  * @see Usu_Validator
  */
  require DIR_WS_MODULES . 'ultimate_seo_urls5/main/validator.php';
  /**
  * @see Data_Registry
  */
  require DIR_WS_MODULES . 'ultimate_seo_urls5/main/registry.php';
  ...
  */
  class Usu_Main {
    ...
    * @return void
    */
    public function initiate( $lng, &$languages_id, &$language ) {
