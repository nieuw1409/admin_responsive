 ...
 */
  class Rewrite_Uri_Module extends aUri_Modules {
    ...
    */
    public function createLinkString( $page, $text, $seperator, $value, $target_language_code ) {
      return usu5_multi_language( $separator = 'right', $target_language_code ) . $text . $seperator . $value . '.html';
    } // end method
    /**
