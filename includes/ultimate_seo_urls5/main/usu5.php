 ...
 */
  ...
  */
  class Usu_Main {
    ...
    * @return string - url
    */
    public function hrefLink( $page, $parameters, $connection, $add_session_id, $search_engine_safe, $target_language_code ) {
     ...
     if ( !array_key_exists( 'initiated', $this->vars ) || ( false === $this->vars['initiated'] ) // USU5 not yet fully initiated
       ...
       return osc_href_link( $page, $parameters, $connection, $add_session_id, $search_engine_safe, $target_language_code );
     }
     if ( false === ( $url = $this->vars['page_modules'][$page_module_name]->buildLink( $page, $parameters, $add_session_id, $connection, $target_language_code ) ) ) {
