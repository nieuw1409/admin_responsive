<?php
/*
  $Id cm_nb_account.php v1.0 20160215 Kymation $
...
*/
  ...
  define('MODULE_CONTENT_NAVBAR_ACCOUNT_TITLE', 'Navbar Gerbuiker');
  define('MODULE_CONTENT_NAVBAR_ACCOUNT_DESCRIPTION', 'Plaats de klant optie in het menu in de navigatiebar.');
/*
