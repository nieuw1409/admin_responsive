...
define('TEXT_MAKE_NEW_CUSTOMER', 'New Customer?  Click here to create an account.') ;
define('TEXT_LOGIN_ERROR_SUSPENDED',        'Error: Your account has been suspended. <a href="' . tep_href_link(FILENAME_CONTACT_US) . '"><strong>Contact us</strong></a> for more information.');
define('TEXT_MOBILE_LOGIN_ERROR_SUSPENDED', 'Error: Your account has been suspended. <a href="' . tep_href_link(FILENAME_MOBILE_CONTACT_US) . '"><strong>Contact us</strong></a> for more information.');
?>