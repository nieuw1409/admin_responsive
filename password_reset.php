...
*/
  ...
  if ($error == false) {
	...
	$email_address2 = tep_db_prepare_input($_GET['account']);
...
$checkemail = true ;
      ...
      if (tep_db_num_rows($check_customer_query)) {
        ...
        $messageStack->add_session('password_forgotten', TEXT_NO_EMAIL_ADDRESS_FOUND . $_GET['account']);
      }
    }
  }
  ...
  if (isset($_GET['action']) && ($_GET['action'] == 'process') && isset($HTTP_POST_VARS['formid']) && ($HTTP_POST_VARS['formid'] == $sessiontoken)) {
