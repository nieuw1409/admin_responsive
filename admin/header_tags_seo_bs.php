   ...
   <table border="0" width="100%" cellspacing="0" cellpadding="2">
       <div class="col-xs-12 col-md-6">
        ...
        <div class="col-xs-12 col-md-6 text-right">
		   ...
		   <?php echo HEADING_TITLE_SUPPORT_THREAD; ?><br />
		   <?php echo HEADING_TITLE_AUTHOR; ?><br />
<?php
           if (function_exists('AnnounceVersion')) {
             if (HEADER_TAGS_ENABLE_VERSION_CHECKER == 'true') {
                echo AnnounceVersion($contribPath, $currentVersion, $contribName); 
             } else {
                echo tep_draw_form('version_check', FILENAME_HEADER_TAGS_SEO, 'action=getversion', 'post');
?>
 	               <div class="form-group"> 
       		          <?php echo  tep_bs_radio_field('version_check', '', TEXT_VERSION_CHECK_UPDATES, 'input_check_for_update',  false, 'radio radio-success radio-inline', '', '', 'right', 'onClick="this.form.submit();"') ; ?><br />
                   </div>
                 </form>
<?php 
             } 
...
?>
              <?php echo TEXT_MISSING_VERSION_CHECKER; ?><br />
<?php 
           } 
?>
		</div>
		...
		<div class="col-xs-12 col-md-8">
		   <div class="panel panel-primary">
		       <div class="panel-heading"><?php echo TEXT_INFORMATION_PAGES ; ?></div>
			   <div class="panel-body">
<?php 
                     echo tep_draw_form('header_tags', FILENAME_HEADER_TAGS_SEO, 'action=update', 'post', 'role="form"') ; 
                         echo tep_draw_bs_pull_down_menu('new_files', $newfiles, null, HEADING_TITLE_SEO_PAGENAME, 'id_get_name_file', 'col-xs-9', ' selectpicker show-tick ', 'col-xs-3', 'left', 'onChange="this.form.submit();"', false) . PHP_EOL ; 
	                     $contents_edit_prod_tab1    = '' ;
                         include( DIR_WS_MODULES . 'header_tags_seo_1.php' ) ;						   
                         
						 if ($currentFile != SELECT_A_FILE && $currentFile != ADD_MISSING_PAGES && count($newfiles) > FIRST_PAGE_ENTRY) { 
?>
                            <div> 
                                <?php echo (tep_image_submit('button_save_bs.jpg', IMAGE_UPDATE) ) . ' <a href="' . tep_href_link(FILENAME_HEADER_TAGS_SEO, '') .'">' . '</a>'; ?>
							</div>
<?php							
                         }   						 
?>					
		   ...
		   </div> <!-- end div class="panel panel-prim -->
		</div> <!-- end div <div class="col-xs-12 co -->
   </table>
