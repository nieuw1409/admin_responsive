...
*/
  ...
  if (isset($_POST['action'])) {
      ...
      $sleep_start_ctr = ($sleep && isset($_POST['sleep_start_ctr']) ? (int)$_POST['sleep_start_ctr'] : 0);
      ...
      $stopLang  = ($languageID == 99 ? GetHighestLanguageID($languages) : $languageID); //what language to end with
              ...
              for ($i = $startLang; $i <= $stopLang; $i++) {
                  ...
                  while ($categories_tags = tep_db_fetch_array($categories_tags_query)) {
                      ...
                      switch ($categories_fill) {
                          case 'empty':
                              if (! tep_not_null($categories_tags['categories_htc_title_tag']) || ! tep_not_null($categories_tags['categories_htc_desc_tag']) || ! tep_not_null($categories_tags['categories_htc_keywords_tag'])) {
                                  $updateDB = true;
                      ...
                      if ($updateDB) {
                          if (isset($_POST['generic_enabled']) && $_POST['generic_enabled'] == 'on') {
                              $addComma = '';
                              $set = ' set ';
                              ...
                              $set = BuildGenericString($set, $addComma, 'categories_htc_desc_tag', $categories_tags['categories_name'], $_POST['add_generic_cat_meta_desc'], tep_db_prepare_input($_POST['generic_cat_meta_desc']));
                              $set = BuildGenericString($set, $addComma, 'categories_htc_keywords_tag', $categories_tags['categories_name'], $_POST['add_generic_cat_keywords'], tep_db_prepare_input($_POST['generic_cat_keywords']));
                              $set = BuildGenericString($set, $addComma, 'categories_htc_description', $categories_tags['categories_name'], $_POST['add_generic_cat_description'], tep_db_prepare_input($_POST['generic_cat_description']));
                          }
                          ...
                          if (! empty($categories_tags['categories_name'])) {
                              ...
                              $fillTagsErrors['categories'][] = '<a class="htc_Link" href="' . tep_href_link(FILENAME_CATEGORIES, 'cID=' . $categories_tags['categories_id']) . '&action=edit_category">' . sprintf(ERROR_FILL_TAGS_CATEGORIES, $categories_tags['categories_id'],$languages[$idPos]['id'] . ' ( '. $languages[$idPos]['name'] . ' ) ' ) . '</a>';
                          }  
                      }           
                  }
              }
              if ($fillTagsCtr['categories'] == 0 && count($fillTagsErrors['categories']) == 0)  {
              ...
              for ($i = $startLang; $i <= $stopLang; $i++) {
                ...
                while ($manufacturers_tags = tep_db_fetch_array($manufacturers_tags_query)) {
                    ...
                    switch ($manufacturers_fill) {
                        case 'empty':
                            if (! tep_not_null($manufacturers_tags['manufacturers_htc_title_tag']) || ! tep_not_null($manufacturers_tags['manufacturers_htc_desc_tag']) || ! tep_not_null($manufacturers_tags['manufacturers_htc_keywords_tag'])) {
                              $updateDB = true;
                    ...
                    if ($updateDB) {          
                        if (isset($_POST['generic_enabled']) && $_POST['generic_enabled'] == 'on') {
                            ...
                            $set = BuildGenericString($set, $addComma, 'manufacturers_htc_title_tag', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_title'], tep_db_prepare_input($_POST['generic_man_title']));
                            $set = BuildGenericString($set, $addComma, 'manufacturers_htc_desc_tag', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_meta_desc'], tep_db_prepare_input($_POST['generic_man_meta_desc']));
                            $set = BuildGenericString($set, $addComma, 'manufacturers_htc_keywords_tag', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_keywords'], tep_db_prepare_input($_POST['generic_man_keywords']));
                            $set = BuildGenericString($set, $addComma, 'manufacturers_htc_description', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_description'], tep_db_prepare_input($_POST['generic_man_description']));
                        }
                        ...
                        if (! empty($manufacturers_tags['manufacturers_name'])) { 
                            ...
                            $fillTagsErrors['manufacturers'][] = '<a class="htc_Link" href="' . tep_href_link(FILENAME_MANUFACTURERS, 'mID=' . $manufacturers_tags['manufacturers_id']) . '&action=edit_category">' . sprintf(ERROR_FILL_TAGS_MANUFACTURERS, $manufacturers_tags['manufacturers_id'],$languages[$idPos]['id'] . ' ( ' . $languages[$idPos]['name'] . ' ) ' ) . '</a>';
                        }    
                    }
                }
            }

            if ($fillTagsCtr['manufacturers'] == 0 && count($fillTagsErrors['manufacturers']) == 0) {
      ...
      if (isset($products_fill)) {  
                  ...
                  while ($products_tags = tep_db_fetch_array($products_tags_query)) {
                      ...
                      switch ($products_fill) {
                        case 'empty':
                            ...
                            if (! tep_not_null($products_tags['products_head_title_tag']) || ! tep_not_null($products_tags['products_head_desc_tag']) || ! tep_not_null($products_tags['products_head_keywords_tag'])) {
                              $updateDB = true;
                    ...
                    if ($updateDB) {
                        ...
                        if ($productsMetaDesc == 'fillMetaDesc_yes')  {        //fill the description with all or part of the product description 
                            ...
                            $set = BuildGenericString($set, $addComma, 'products_head_title_tag', $products_tags['products_name'], $_POST['add_generic_prod_title'], tep_db_prepare_input($_POST['generic_prod_title']));
                            $set = BuildGenericString($set, $addComma, 'products_head_desc_tag', $products_tags['products_name'], $_POST['add_generic_prod_meta_desc'], tep_db_prepare_input($_POST['generic_prod_meta_desc']));
                            $set = BuildGenericString($set, $addComma, 'products_head_keywords_tag', $products_tags['products_name'], $_POST['add_generic_prod_keywords'], tep_db_prepare_input($_POST['generic_prod_keywords']));
                      } else {        
                          $desc = $products_tags['products_name'];           
                      }  
                      ...
                      if (! empty($products_tags['products_name'])) {            
                          ...
                          $fillTagsErrors['products'][] = '<a class="htc_Link" href="' . tep_href_link(FILENAME_CATEGORIES, 'pID=' . $products_tags['products_id']) . '&action=new_product">' . sprintf(ERROR_FILL_TAGS_PRODUCTS, $products_tags['products_id'],$languages[$idPos]['id'] . ' ( '. $languages[$idPos]['name'] . ' ) ' ) . '</a>';
                      }  
                  } 
              }
          }
          ...
          if ($fillTagsCtr['products'] == 0 && count($fillTagsErrors['products']) == 0) {
...
<table border="0" width="100%" cellspacing="2" cellpadding="2">
  <tr>
    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="0">
     ...
     <tr>
      <td class="HTC_subHead"><?php echo sprintf(TEXT_FILL_TAGS, sprintf(TEXT_SHOW_POPUP, 'TEXT_EXPLAIN_SLEEP')); ?></td>
     </tr>
      ...
      <td align="right"><?php echo tep_draw_form('header_tags', FILENAME_HEADER_TAGS_FILL_TAGS, '', 'post') . tep_draw_hidden_field('action', 'process'); ?></td>
        ...
        <td><table border="1" class="HTC_Box" cellpadding="0">
         ...
         <tr>
          <td width="55%"><table border="0" width="100%" cellpadding="0">    
             ...
             <tr>
              <td valign="top"><table border="0" width="100%" cellpadding="0">
               <tr style="background-color:#FAF8CC">
                <td class="main" align="center" style="font-weight:bold;"><?php echo TEXT_OVERRIDE_DESCRIPTION . sprintf(TEXT_SHOW_POPUP, 'TEXT_OVERRIDE_DESCRIPTION'); ?></td>     
               </tr> 
               <tr class="main"> 
              ...
              <td width="50%" valign="top"><table border="0" width="100%" >
               <tr style="background-color:#FAF8CC">
                <td class="main" align="center" style="font-weight:bold;"><?php echo TEXT_OVERRIDE_KEYWORDS . sprintf(TEXT_SHOW_POPUP, 'TEXT_OVERRIDE_KEYWORDS'); ?></td>
               </tr>               
           ...
           <tr><td class="main" align="center" style="font-weight: bold; background-color: #FAF8CC"><?php echo TEXT_OVERRIDE_GENERIC . sprintf(TEXT_SHOW_POPUP, 'TEXT_OVERRIDE_GENERIC'); ?></td></tr>               
           <tr class="main"> 
           ...
           <tr>
            <td width="100%"><table border="0" width="24%" class="HTC_Box"> 
             ...
             <tr class="main"> 
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_cat_title', TEXT_GENERIC_TITLE, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>
             <tr class="main"> 
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_cat_meta_desc', TEXT_GENERIC_DESC, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>       
             <tr class="main"> 
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_cat_keywords', TEXT_GENERIC_KEYWORDS, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>   
             <tr class="main"> 
              ...
              <td class="main"><?php echo tep_draw_textarea_field('generic_cat_description', 'hard', 57, 8, TEXT_GENERIC_DESCRIPTION, 'disabled', false); ?></td>
             </tr>   
            </table></td> 
           </tr> 
           ...
           <tr>
            <td width="100%"><table border="0" width="24%" class="HTC_Box"> 
             ...
             <tr class="main"> 
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_man_title', TEXT_GENERIC_TITLE, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>
             <tr class="main"> 
              <td><?php echo TEXT_FILL_GENERIC_META_DESC; ?></td>
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_man_meta_desc', TEXT_GENERIC_DESC, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>       
             <tr class="main"> 
              <td><?php echo TEXT_FILL_GENERIC_KEYWORDS; ?></td>
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_man_keywords', TEXT_GENERIC_KEYWORDS, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>   
             <tr class="main"> 
              <td valign="top"><?php echo TEXT_FILL_GENERIC_DESCRIPTION; ?></td>
              ...
              <td class="main"><?php echo tep_draw_textarea_field('generic_man_description', 'hard', 57, 8, TEXT_GENERIC_DESCRIPTION, 'disabled', false); ?></td>
             </tr>               
            </table></td> 
           </tr> 
           ...
           <tr>
            <td width="100%"><table border="0" width="24%" class="HTC_Box"> 
             ...
             <tr class="main"> 
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_prod_title', TEXT_GENERIC_TITLE, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>
             <tr class="main"> 
              <td><?php echo TEXT_FILL_GENERIC_META_DESC; ?></td>
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_prod_meta_desc', TEXT_GENERIC_DESC, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>       
             <tr class="main"> 
              <td><?php echo TEXT_FILL_GENERIC_KEYWORDS; ?></td>
              ...
              <td class="main"><?php echo tep_draw_input_field('generic_prod_keywords', TEXT_GENERIC_KEYWORDS, 'maxlength="255" size="61" disabled', false); ?> </td>
             </tr>   
            </table></td> 
           </tr>                       
       ...
       <tr>        
        <td><table border="1" width="100%" class="HTC_Box">
         <tr> 
          <td colspan="3" class="HTC_title"><?php echo HEADING_TITLE_FILL_TAGS_OPTIONS . sprintf(TEXT_SHOW_POPUP, 'TEXT_EXPLAIN_FILLTAGS'); ?></td>
         </tr> 
         <tr>
          <td width="55%"><table border="2" width="100%">
           <tr>
            <td><table border="0" width="100%">
             ...
             <tr class="smallText">          
              <td title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group1" VALUE="none" <?php echo (isset($checkedCats['none']) ? $checkedCats['none'] : ''); ?> id="rad01" ><label for="rad01"><?php echo HEADING_TITLE_SEO_SKIPALL; ?></label></td>
              <td title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group2" VALUE="none" <?php echo (isset($checkedManuf['none']) ? $checkedManuf['none'] : ''); ?> id="rad02" ><label for="rad02"><?php echo HEADING_TITLE_SEO_SKIPALL; ?></label></td>
              <td title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group3" VALUE="none" <?php echo (isset($checkedProds['none']) ? $checkedProds['none'] : ''); ?> id="rad03" ><label for="rad03"><?php echo HEADING_TITLE_SEO_SKIPALL; ?></label></td>
             </tr>
             <tr class="smallText"> 
              <td title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="empty" <?php echo (isset($checkedCats['empty']) ? $checkedCats['empty'] : ''); ?> id="rad11" ><label for="rad11"><?php echo HEADING_TITLE_SEO_FILLONLY; ?></label></td>
              <td title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="empty" <?php echo (isset($checkedManuf['empty']) ? $checkedManuf['empty'] : ''); ?> id="rad12" ><label for="rad12"><?php echo HEADING_TITLE_SEO_FILLONLY; ?></label></td>
              <td title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="empty" <?php echo (isset($checkedProds['empty']) ? $checkedProds['empty'] : ''); ?> id="rad13" ><label for="rad13"><?php echo HEADING_TITLE_SEO_FILLONLY; ?></label></td>
             </tr>
             <tr class="smallText"> 
              <td title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="full" <?php echo (isset($checkedCats['full']) ? $checkedCats['full'] : ''); ?> id="rad21" ><label for="rad21"><?php echo HEADING_TITLE_SEO_FILLALL; ?></label></td>
              <td title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="full" <?php echo (isset($checkedManuf['full']) ? $checkedManuf['full'] : ''); ?> id="rad22" ><label for="rad22"><?php echo HEADING_TITLE_SEO_FILLALL; ?></label></td>
              <td title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="full" <?php echo (isset($checkedProds['full']) ? $checkedProds['full'] : ''); ?> id="rad23" ><label for="rad23"><?php echo HEADING_TITLE_SEO_FILLALL; ?></label></td>
             </tr>
             <tr class="smallText"> 
              <td title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="clear" <?php echo (isset($checkedCats['clear']) ? $checkedCats['clear'] : ''); ?> id="rad31" ><label for="rad31"><?php echo HEADING_TITLE_SEO_CLEARALL; ?></label></td>
              <td title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="clear" <?php echo (isset($checkedManuf['clear']) ? $checkedManuf['clear'] : ''); ?> id="rad32" ><label for="rad32"><?php echo HEADING_TITLE_SEO_CLEARALL; ?></label></td>
              <td title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="clear" <?php echo (isset($checkedProds['clear']) ? $checkedProds['clear'] : ''); ?> id="rad33" ><label for="rad33"><?php echo HEADING_TITLE_SEO_CLEARALL; ?></label></td>
             </tr>
            </table></td>         
           </tr> 
           <tr>
            <td width="55%"><table border="0" width="95%" cellspacing="0" cellpadding="2">
             <tr class="smallText"> 
              ...
              <td title="<?php echo $filltagsPopup['enable_sleep']; ?>"><INPUT TYPE="checkbox" NAME="enable_sleep" <?php echo ($sleep ? 'checked=true' : ''); ?> id="enable_sleep" onchange="ChangeIntervalState();"><?php echo HEADING_TITLE_SEO_ENABLE_SLEEP; ?></td>
              <td title="<?php echo $filltagsPopup['enable_sleep_interval']; ?>"><INPUT TYPE="text" NAME="enable_sleep_interval" value="<?php echo ($sleep && $sleep_interval ? $sleep_interval : ''); ?>" size="2" <?php echo ($sleep && $sleep_interval ? '' : 'disabled'); ?> id="enable_sleep_interval">&nbsp;<?php echo HEADING_TITLE_SEO_ENABLE_SLEEP_INTERVAL; ?></td>
              <?php echo tep_draw_hidden_field('sleep_start_ctr', $sleep_start_ctr) . tep_draw_hidden_field('sleep_total', $sleep_total); ?>
             </tr>
            </table></td>
           </tr>  
            ...
            <td width="55%"><table border="0" width="95%" cellspacing="0" cellpadding="2">
             <tr class="smallText">             
              ...
              <?php  //add an all languages button
               if ($langCnt > 1) { ?>
                <td align=left><INPUT TYPE="radio" NAME="language_group" VALUE="language_99" <?php echo ($languageID == 99 ? 'checked' : ''); ?> ><?php echo TEXT_FILL_ALL_LANGUAGES; ?></td>
              <?php 
               }  
               
               for ($i = 0, $n = $langCnt; $i < $n; ++$i) {
              ?>   
                <td align="left"><INPUT TYPE="radio" NAME="language_group" VALUE="language_<?php echo $languages[$i]['id']; ?>" <?php echo (($languageID - 1) == $i ? 'checked' : ''); ?> ><?php echo $languages[$i]['name']; ?></td>
              <?php } ?>
             </tr>
            </table></td>   
           </tr> 
           ...
           <tr>
            <td><table border="0" width="100%">
             ...
             <?php if (tep_not_null($updateTextCat)) { ?>
              <tr>
               <td class="HTC_subHead"><?php echo sprintf($updateTextCat, ($sleep ? $sleep_total : $fillTagsCtr['categories'])); ?></td>
              </tr> 
              <?php 
               if (isset($fillTagsErrors['categories']) && count($fillTagsErrors['categories']) > 0) {
              ...
              <tr>
               <td class="HTC_subHead"><?php echo sprintf($updateTextManuf, ($sleep ? $sleep_total : $fillTagsCtr['manufacturers'])); ?></td>
              </tr>

              <?php 
               if (isset($fillTagsErrors['manufacturers']) && count($fillTagsErrors['manufacturers']) > 0) {
             ...
             <?php } 
              ...
              <tr>
               <td class="HTC_subHead"><?php echo sprintf($updateTextProd, ($sleep ? $sleep_total : $fillTagsCtr['products'])); ?></td>
              </tr>

              <?php 
               if (isset($fillTagsErrors['products']) && count($fillTagsErrors['products']) > 0) {
