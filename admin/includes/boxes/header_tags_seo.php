...
*/
  ...
  $cl_box_groups[] = array(
	'icon' => BOX_HEADING_HEADER_TAGS_ICON,  
    'heading' => BOX_HEADING_HEADER_TAGS_SEO,
    'apps' => array(
      array(
        'code' => FILENAME_HEADER_TAGS_SEO_PAGES,
        'title' => BOX_HEADER_TAGS_ADD_A_PAGE,
        'link' => tep_href_link(FILENAME_HEADER_TAGS_SEO_PAGES)
      ),
     array(
        'code' => FILENAME_HEADER_TAGS_SEO_PAGES_DEFAULT,
        'title' => BOX_HEADER_TAGS_ADD_PAGE_DEFAULT,
        'link' => tep_href_link(FILENAME_HEADER_TAGS_SEO_PAGES_DEFAULT)
      ),	  
      array(
