 ...
 */
    ...
    function send($to_name, $to_addr, $from_name, $from_addr, $subject = '', $headers = '', $replace_string = '', $replace_text = '') {
	  ...
	  if ( $replace_string != '' ) {
	      $this->output = preg_replace($replace_string,                    $replace_string,                    $this->output);  // used in newsletter to set the unsubscribe link
	  }
