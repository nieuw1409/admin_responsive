...
<style type="text/css">
<!--
div.section_row {clear:both; margin-left:auto; margin-right:auto; width:740px; padding-top:0px; }
div.section_column a:link { float:left; width:80px; padding-left:10px; color:#A0522D; text-align:center;}
-->
</style>
<?php
define('HEADING_TITLE', 'Header Tags SEO');
define('HEADING_TITLE_AUTHOR', 'by Jack_mcs from <a href="http://www.oscommerce-solution.com/" target="_blank"><span class="mark">oscommerce-solution.com</span></a>');
define('HEADING_TITLE_FILL_TAGS', 'Header Tags SEO - Vul Tags');
define('HEADING_TITLE_FILL_TAGS_OPTIONS', 'Vul Tags');
define('HEADING_TITLE_FILL_TAGS_OVERRIDES', 'Handmatige OPTIES');
define('HEADING_TITLE_SUPPORT_THREAD', '<a href="http://forums.oscommerce.com/topic/298099-header-tags-seo" target="_blank"><span class="mark">(visit the support thread)</span></a>');


define('TEXT_INFORMATION_PAGES', 'Deze Column beheerd de individuele paginas. Vul hier de tekst in. Als de standaard checkboxes actief zijn, worden de standaard tags ( zie rechter column) toegevoegd aan de paginas.');
define('TEXT_INFORMATION_DEFAULT', 'De instelling in deze column zijn de standaard en globale items. 
   De Tekst die hier ingevuld en selecteerd zijn worden getoond in de header tags in de paginas waarin de header tags zijn geplaatst.');
define('TEXT_INFORMATION_DELETE_PAGE', '<b>Verwijder een Nieuwe Pagina</b> - Deze optie verwijderd de code van de bovenstaande bestanden.'); 
define('TEXT_INFORMATION_CHECK_PAGES', '<b>Check Missing Pageginas</b> - Deze optie controleerd voor welke bestanden geen Header Tags gegevens zijn ingevoerd. 
                                         Let op niet alle paginas kunnen Header Tags bevatten. BV elke pagina welke gebruik maakt van SSL zoals Login of Aanmaken Klanten( Create Account ).
										 Om de paginas te bekijken , click op Update en selecteer het bestand uit de drop down list.'); 

define('TEXT_PAGE_TAGS', 'Deze pagina beheerd de instellingen van alle ( beschikbare ) paginas in de winkel. 
                          Om de HeaderTags te gebruiken voor een bepaalde pagina moet de bijbehorende Code geinstaleerd zijn in het bestand.
						  Zie de Install_Catalog.txt van de desbetreffende contribution ( http://addons.oscommerce.com/info/5851 ).This page allows the setting up of titles and tags for all of the pages in a shop. Please
...
for those pages is more important than the for other pages. Click one of the following links for help on the 
indicated topic:
<div>
    ' . tep_draw_bs_button('Pagina Controle', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=page_control"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Vul Tags', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=filltags"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Sleutelwoord Google', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=keywords"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Opties', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=options"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Silo Controle', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=silo"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Sociale Sleutelwoord', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=social"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Testen', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=test"), null, null, 'btn-default text-danger') . '
    ' . tep_draw_bs_button('Help ?', 'info-sign', tep_href_link(FILENAME_HEADER_TAGS_SEO, "file=need_help"), null, null, 'btn-default text-danger') . '	  
</div>
<div id="hts_help" title="Header Tags SEO Help" class="ui-state-active"></div>
');
...
define('TEXT_EXPLAIN_POPUP', 'Uitleg');

// header_tags_seo.php
define('HEADING_TITLE_SEO_DELETE', 'Verwijder:');
define('HEADING_TITLE_SEO_EXPLAIN', '(Uitleg)');
define('HEADING_TITLE_SEO_TITLE', 'Titel:');
define('HEADING_TITLE_SEO_DESCRIPTION', 'Omschrijving:');
define('HEADING_TITLE_SEO_KEYWORDS', 'Keyword(s):');
define('HEADING_TITLE_SEO_LOGO', 'Logo Tekst:');
define('HEADING_TITLE_SEO_HOME_PAGE', 'Home Pagina:');
define('HEADING_TITLE_SEO_OPTIONS', 'Toevoegen:');
define('HEADING_TITLE_SEO_PAGENAME', 'Selecteer een Optie::');
define('HEADING_TITLE_SEO_PAGENAME_ERROR', 'Pagina naam is reeds ingevoerd -> ');
define('HEADING_TITLE_SEO_PAGENAME_INVALID_ERROR', 'Pagina naam is niet toegestaan -> ');
define('HEADING_TITLE_SEO_NO_DELETE_ERROR', 'Verwijder van %s is niet toegestaan');
define('HEADING_TITLE_SEO_VIEW_RESULT', 'Voorbeeld:');
define('HEADING_TITLE_TEST', 'Test de Installatie');

define('HEADING_TITLE_SEO_DEFAULT_TAGS', 'Default Tags');
define('HEADING_TITLE_SEO_DEFAULT_META_TAGS', 'Meta Tags');
define('HEADING_TITLE_SEO_DEFAULT_DESCRIPTION', 'Standaard Omschrijving:');
define('HEADING_TITLE_SEO_DEFAULT_KEYWORDS', 'Standaard Keyword(s):');
define('HEADING_TITLE_SEO_DEFAULT_LOGO', 'Logo Tekst');

define('HEADING_TITLE_SEO_PSEUDO', 'Voeg een Pseudo Pagina toe:');

// header_tags_fill_tags.php
define('HEADING_TITLE_SEO_CATEGORIES', 'CATEGORIEN');
define('HEADING_TITLE_SEO_MANUFACTURERS', 'FABRIKANT');
define('HEADING_TITLE_SEO_PRODUCTS', 'PRODUCTEN');
define('HEADING_TITLE_SEO_SKIPALL', 'Overslaan alle tags');
define('HEADING_TITLE_SEO_FILLONLY', 'Vul aleen lege tags');
define('HEADING_TITLE_SEO_FILLALL', 'Vul alle tags');
define('HEADING_TITLE_SEO_CLEARALL', 'Verwijder alle tags');
define('HEADING_TITLE_SEO_ENABLE_SLEEP', 'Sleep:');
define('HEADING_TITLE_SEO_ENABLE_SLEEP_INTERVAL', 'Aantal:');
define('HEADING_TITLE_SEO_SHOW_MISSING_TAGS', 'Toon Ontbrekende Tags');
define('HEADING_TITLE_SEO_INCLUDE_MISSING_DESCRIPTION', 'Voeg Ontbrekende Omschrijvingen in de zoekopdracht');
...
define('TEXT_CHECK_URL_PAGE', 'Pagina Naam');
define('TEXT_CHECK_URL_TAGS', 'ID (indien nodig)');
define('TEXT_CLOSE_POPUP', 'Sluit dit Scherm');
define('TEXT_FILL_ALL_LANGUAGES', 'Alles');
define('TEXT_FILL_CATEGORIES_CLEAR', 'Alle %s Categorien tags zijn verwijderd.');
define('TEXT_FILL_CATEGORIES_EMPTY', '%s Lege Categorien tags zijn gevuld .');
define('TEXT_FILL_CATEGORIES_FULL', '%s Categorien tags zijn gevuld.');
define('TEXT_FILL_KEYWORDS_FROM_SHOP', 'Vul keywords voor alle toegeveogde paginas met de keywords van de getoonde paginas?');
define('TEXT_FILL_WITH_DESCIPTION', 'Vul de product meta omschrijving met de omschrijving van de producten?');
define('TEXT_FILL_KEYWORDS_WITH_GENERIC', 'Check to fill title and tags with generic strings.');
define('TEXT_FILL_GENERIC_TITLE', 'Titel:');
define('TEXT_FILL_GENERIC_META_DESC', 'Omschrijving:');
define('TEXT_FILL_GENERIC_KEYWORDS', 'Keywords:');
define('TEXT_FILL_GENERIC_DESCRIPTION', 'Omschrijving: (pagina)');
define('TEXT_FILL_GENERIC_SECTION_CATEGORIES', 'Categorien');
define('TEXT_FILL_GENERIC_SECTION_MANUFACTURERS', 'Fabrikant');
define('TEXT_FILL_GENERIC_SECTION_PRODUCTS', 'Product(en)');
...
define('TEXT_PSEUDO_PAGE_NAME_NOTE', 'De pagina naam moet worden ingevoerd zoals op de pagina wordt weergegeven, met de hoofdmap pagina
inbegrepen. Bijvoorbeeld, als de artikelen Manager is geïnstalleerd, de basis pagina voor artikelen is article_info.php. de
extra artikelen zou een ID hebben, zoals articles_id = 2. Dus om een dergelijke pagina toe te voegen, zou je article_info.php invoeren? Articles_id = 2. <br>
<span class="ui-state-highlight"> Opmerking: Voeg ontbrekende pagina <b> moet </ b> worden liep voorafgaand aan het gebruik van deze optie om ervoor te zorgen de
root-bestand aanwezig is' );
