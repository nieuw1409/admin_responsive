...
define('HEADING_TITLE', 'Newsletter Subscribe Email text');
...
define('TEXT_EMAIL_ORDER_TEXT', 'Newsletter Subscribe Email text' ) ;
...
define('POPUP_EMAIL_ADDRESS',           'Newsletter Subscriber Email Adres'); // 232
define('POPUP_CUSTOMER_NAME',           'Newsletter Subscriber Name'); // 232
define('POPUP_UNSUBSCRIBE_LINK',        'Link for Unsubscribe'); // 232
?>