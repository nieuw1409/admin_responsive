...
define('ENTRY_STORES_ID', 'Active Store');
define('TEXT_SELECT_STORES', 'Select Store') ;
...
define('TEXT_NO_ORDER_STATUS', 'Order Status Unknow');
define('TEXT_PRODUCTS_TABLE', 'Products');
define( 'TEXT_COLLAPSE_ADRESS', 'Customer Adress and Payment') ;
define( 'TEXT_COLLAPSE_ORDER_STATUS', 'Status + History Order Status') ;
define( 'TEXT_ORDER_PRODUCTS', 'This order has the following products');
?>
