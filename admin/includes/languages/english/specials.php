...
define('TEXT_SPECIALS_GROUPS', 'Customer Group:'); // BOF Separate Pricing Per Customer, specials code
define('TEXT_INFO_HEADING_EDIT_SPECIALS', 'Modify Specials');
define('TEXT_INFO_HEADING_NEW_SPECIALS', 'Add Specials');
?>