...
define('ENTRY_STREET_ADDRESS_TEXT', 'address');
...
define('TEXT_OR_BY_EMAIL', 'or select by customer Email:'); 
define('TEXT_OR_BY_NAME', 'or select by customer Name:'); 
...
define('ENTRY_NEWSLETTER_SUBSCRIBE_TEXT','1 = subscribed, <br />or 0 (Zero) = not subscribed.');
define('TEXT_SELECT_STORES_TITLE','Store Choice'); // MULTI STORES
define('TEXT_SELECT_STORES', 'Select Store '); // MULTI STORES
define('ENTRY_STORES','Stores'); // MULTI STORES
?>