...
define('TEXT_BANNERS_NEW_GROUP', 'New banner group');
define('TEXT_BANNERS_IMAGE', 'Image:');
define('TEXT_BANNERS_IMAGE_LOCAL', 'Local file name for image');
define('TEXT_BANNERS_IMAGE_TARGET', 'Image Target Name (Save To):');
...
define('TEXT_INFO_HEADING_DELETE_BANNER', 'Delete Banner' ) ;
define('TEXT_INFO_HEADING_EDIT_BANNER', 'Change Banner' ) ;
define('TEXT_INFO_HEADING_NEW_BANNER', 'Add Banner' ) ;
