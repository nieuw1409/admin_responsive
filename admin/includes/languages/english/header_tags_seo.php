...
define('HEADING_TITLE_AUTHOR', 'by Jack York from <a href="http://www.oscommerce-solution.com/" target="_blank"><span class="mark">oscommerce-solution.com</span></a>');
...
define('SHADOW_POS_X', '20');
define('SHADOW_POS_Y', '10');
define('SHADOW_POS_OFFSET', '110');

define('TEXT_PAGE_TAGS', '<div style="height:44px">This page allows the setting up of titles and tags for all of the pages in a shop. Please
...
<div class="section_row" style="position:relative; margin-left:auto; margin-right:auto; width:100%; padding-top:6px;">
  ...
  <div class="section_row shadow" style="position:absolute; left:' . (SHADOW_POS_X + (6 * SHADOW_POS_OFFSET)). 'px; top:' . SHADOW_POS_Y . 'px">
  ...
  <div class="section_row shadow" style="position:absolute; left:' . (SHADOW_POS_X + (7 * SHADOW_POS_OFFSET)). 'px; top:' . SHADOW_POS_Y . 'px">
  ...
  <div class="section_row shadow" style="position:absolute; left:' . (SHADOW_POS_X + (8 * SHADOW_POS_OFFSET)). 'px; top:' . SHADOW_POS_Y . 'px">
