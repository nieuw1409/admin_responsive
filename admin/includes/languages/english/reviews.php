...
define('TEXT_INFO_HEADING_EDIT_ZONE', 'Change Product Review') ;

define('TEXT_RATING_1', "Bad") ;
define('TEXT_RATING_2', "Average") ;
define('TEXT_RATING_3', "Normal") ;
define('TEXT_RATING_4', "Good") ;
define('TEXT_RATING_5', "Exellent") ;
?>