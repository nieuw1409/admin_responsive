...
// define the database table names used in the project
  ...
  define('TABLE_HEADERTAGS_KEYWORDS',              'headertags_keywords');  /*** Begin Header Tags SEO ***/
  define('TABLE_HEADERTAGS_SEARCH',                'headertags_search');  /*** Begin Header Tags SEO ***/
  ...
  define('TABLE_EMAIL_ORDER_TEXT',                 'eorder_text');    // email html orders new customer etc
  ...
  define('TABLE_INFORMATION_GROUP',                'information_group');   // BOF: Information Pages Unlimited
  ...
  define('TABLE_PRODUCTS_PRICE_BREAK',             'products_price_break'); // BOF QPBPP for SPPC
  define('TABLE_DISCOUNT_CATEGORIES',              'discount_categories'); // BOF QPBPP for SPPC
  ...
  define('TABLE_CONFIGURATION_LANGUAGES',          'configuration_languages');  //++++ QT Pro: Begin Changed code    
  ...
  define('TABLE_CATEGORIES_TO_STORES',             'categories_to_stores');  //rmh M-S_multi-stores
  define('TABLE_LANGUAGES_TO_STORES',              'languages_to_stores'); //rmh M-S_multi-stores
  define('TABLE_MANUFACTURERS_TO_STORES',          'manufacturers_to_stores'); //rmh M-S_multi-stores
  define('TABLE_PRODUCTS_TO_STORES',               'products_to_stores'); //rmh M-S_multi-stores
  define('TABLE_STORES',                           'stores');   //rmh M-S_multi-stores
  define('TABLE_DISTRIBUTORS',                     'distributors');   //rmh M-S_multi-stores
  ...
  define('TABLE_NEWSLETTER_SUBSCRIPTION',          'newsletter_subscription');  // BOF Visitor's Newsletter Contribution by brouillard s'embrouille
  define('TABLE_BANNED_IP',                        'banned_ip');   // banned ip
?>