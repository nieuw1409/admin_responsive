   ...
   <table border="0" width="100%" cellspacing="0" cellpadding="2">
          <div class="page-header">
            ...
            <div class="col-md-6">
              <div class="row">               
<?php
                    echo tep_draw_bs_form('lng', FILENAME_DEFINE_MAINPAGE, '','GET', 'role="form"', 'cust_select') . PHP_EOL;				                         
...
<?php			 
                 echo tep_draw_bs_form('language', FILENAME_DEFINE_MAINPAGE, 'lngdir=' . $HTTP_GET_VARS['lngdir'] . '&filename=' . $HTTP_GET_VARS['filename'] . '&action=save', 'post', 'class="form-inline" role="form"', 'id_def_cond') ;
?>	  
