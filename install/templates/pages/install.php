...
<!--
  ...
  function prepareDB() {
    ...
    $.get('rpc.php?action=dbCheck&server=' + encodeURIComponent(dbServer) + '&username=' + encodeURIComponent(dbUsername) + '&password=' + encodeURIComponent(dbPassword) + '&name=' + encodeURIComponent(dbName), function (response) {
      ...
      if (result[0] == '1') {
        $('#mBoxContents').html('<p><img src="images/progress.gif" align="right" hspace="5" vspace="5" /><?php echo CONNECT_IMPORTED; ?></p>');
        ...
        $.get('rpc.php?action=dbImport&server=' + encodeURIComponent(dbServer) + '&username=' + encodeURIComponent(dbUsername) + '&password='+ encodeURIComponent(dbPassword) + '&name=' + encodeURIComponent(dbName), function (response2) {
          ...
          if (result2[0] == '1') {
            $('#mBoxContents').html('<p><img src="images/success.gif" align="right" hspace="5" vspace="5" /><?php echo CONNECT_SUCCESSFULLY; ?></p>');
            ...
            $('#mBoxContents').html('<p><img src="images/failed.gif" align="right" hspace="5" vspace="5" /><?php echo CONNECT_PROBLEM; ?></p>'.replace('%s', result2_error));
